...
class PromotionalAdapter (private val groupsViewModel: PromotionalViewModel, private val context: Context?) : RecyclerView.Adapter<PromotionalAdapter.BaseViewHolder<*>>() {
